...
gulp.task('default', gulp.series(/*'watch-fluent',*/ 'watch-material'))
gulp.task('watch', gulp.series(/*'watch-fluent',*/ 'watch-material'))
gulp.task('build', gulp.series('build-wireframe', 'build-fluent', 'build-material'))
