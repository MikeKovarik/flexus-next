...
export class ImageTransition {
	...
	async play() {
		...
		await this.ready
		var nodeToAnimate = this.clone || this.target
		this.animation = nodeToAnimate.animate(this.keyframes, this.options)
